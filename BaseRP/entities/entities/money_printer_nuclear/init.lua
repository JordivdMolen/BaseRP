...
ENT.SeizeReward = 950
local Name = "Nuclear Money Printer"
local Color=Color( 255, 0, 0, 255 )
local PrintAmount = 1000
local PrintTime1 = 5 --Range of the random timer--
local PrintTime2 = 1
local HeatSystem = true
local Health = 10000 -- Health
local PrintDis1 = 1200 --Range of the random timer of Inactive--
local PrintDis2 = 6000
local RefillPrice = 500 -- The Rifill Price --
local PrintMore
...
function ENT:CreateMoneybag()
	...
	if Status1 == 1 then
	local moneybag = DarkRP.createMoneyBag(Vector(MoneyPos.x + 0, MoneyPos.y + 0, MoneyPos.z + 0), amount)
