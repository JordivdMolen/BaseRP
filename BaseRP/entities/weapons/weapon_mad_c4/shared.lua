...
function SWEP:Deploy()
	...
	self.Weapon:SetNextPrimaryFire(CurTime() + (self.DeployDelay or 10))
	self.Weapon:SetNextSecondaryFire(CurTime() + (self.DeployDelay or 10))
	self.ActionDelay = (CurTime() +(self.DeployDelay or 10))
